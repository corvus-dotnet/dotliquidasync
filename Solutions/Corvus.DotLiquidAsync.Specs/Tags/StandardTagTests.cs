namespace DotLiquid.Tests.Tags
{
    ...
    public class StandardTagTests
    {
        ...
        public class TestDictObject : Drop
        {
            ...
            {
                this.Testdict = new Dictionary<string, string>() { { "aa", "bb" }, { "dd", "ee" }, { "ff", "gg" } };
            }
        ...
        public async Task TestDictionaryFor()
        {
            ...
            string result = await template.RenderAsync(Hash.FromAnonymousObject(new { bla = new TestDictObject() }));
...
{%endfor%}";
        ...
        {
            var assigns = Hash.FromAnonymousObject(new { array = new[] { 1, 2, 3 } });
        ...
        {
            var assigns = Hash.FromAnonymousObject(new { array = new[] { new[] { 1, 2 }, new[] { 3, 4 }, new[] { 5, 6 } } });
        ...
        public async Task TestForWithBreak()
        {
            ...
            string markup = "{% for i in array.items %}{{ i }}{% if i > 3 %}{% break %}{% endif %}{% endfor %}";
        ...
        {
            string markup = "123{% continue %}456";
            string expected = "123";
            await Helper.AssertTemplateResultAsync(expected, markup);
        }
        ...
        {
            var assigns = Hash.FromAnonymousObject(new { var = "content" });
        ...
        {
            var assigns = Hash.FromDictionary(new Dictionary<string, object> { { "a-b", "1" } });
        ...
        {
            var assigns = Hash.FromAnonymousObject(new { var = new Dictionary<string, object> { { "a:b c", new { paged = 1 } } } });
        ...
        {
            var assigns = Hash.FromAnonymousObject(new { condition = 2 });
        ...
        {
            var assigns = Hash.FromAnonymousObject(new { array = new[] { 1, 2, 3, 4 } });
        ...
        {
            var assigns = Hash.FromAnonymousObject(new { hash = Hash.FromAnonymousObject(new { a = 1, b = 2, c = 3, d = 4 }) });
